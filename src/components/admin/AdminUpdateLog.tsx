...
export default function AdminUpdateLog() {
  ...
  const specUpdates = updateLog.filter(
    (e) => e.type === "spec_update" || e.type === "price_update"
  );
  const latestDate =
    updateLog.length > 0
      ...
      <SimpleGrid columns={{ base: 2, md: 4 }} spacing={4} mb={8}>
        {[
          ...
          { label: "Spec Updates", value: specUpdates.length },
          {
            ...
            value: new Set(updateLog.filter((e) => e.carId).map((e) => e.carId)).size,
          },
